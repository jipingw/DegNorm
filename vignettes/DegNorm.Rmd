...
![A diagram of DegNorm.](degnorm_logo.png){width=90%}  
...
```{r,fig.width=6,fig.height=5,message=FALSE,eval=TRUE}
##gene named "SOD1"
...
```{r,fig.width=6,fig.height=5,message=FALSE,warning=FALSE,eval=TRUE}
